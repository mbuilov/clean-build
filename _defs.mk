...
GET_VARIANTS_OF = $(call FILTER_VARIANTS_LIST,$1,$(wordlist 2,999999,$($1)),$2)

# get target variants list or default variant R
# $1 - EXE,LIB,...
GET_VARIANTS = $(call GET_VARIANTS_OF,$1)
...
ifneq ($$($t),)
$$(foreach v,$$(call GET_VARIANTS_OF,$t,$3),$$(info $$(if $$(CB_TOOL_MODE),[TOOL]: )$t $$(subst \
...
CLEAN_BUILD_PROTECTED_VARS += MTOP MAKEFLAGS NO_DEPS DEBUG PROJECT \
  ...
  FILTER_VARIANTS_LIST GET_VARIANTS_OF GET_VARIANTS GET_TARGET_NAME DEBUG_TARGETS1 GET_DEBUG_TARGETS FORM_OBJ_DIR \
