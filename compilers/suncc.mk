...
# $3 - source
# $4 - prefixes of system includes to filter out - $(UDEPS_INCLUDE_FILTER)
ifdef NO_DEPS
WRAP_CC = $1
else
...
CMN_CXX = $(call SUP,$(TMD)CXX,$2)$(call \
  WRAP_CC,$($(TMD)CXX) $(DEF_CXXFLAGS) $(CC_PARAMS) $(CXXOPTS) -o $1 $2 $(CXXFLAGS),$1,$2,$(UDEPS_INCLUDE_FILTER))
CMN_CC  = $(call SUP,$(TMD)CC,$2)$(call \
  WRAP_CC,$($(TMD)CC) $(DEF_CFLAGS) $(CC_PARAMS) $(COPTS) -o $1 $2 $(CFLAGS),$1,$2,$(UDEPS_INCLUDE_FILTER))
...
CMN_PCXX = $(call SUP,$(TMD)PCXX,$2)$(call WRAP_CC,$($(TMD)CXX) -xpch=use:$(dir $1)$(basename $(notdir \
  $(PCH)))_cc $(DEF_CXXFLAGS) $(CC_PARAMS) $(CXXOPTS) -o $1 $(PCH_GEN_DIR)$(notdir $2).cc $(CXXFLAGS),$1,$2,$(UDEPS_INCLUDE_FILTER))
CMN_PCC  = $(call SUP,$(TMD)PCC,$2)$(call WRAP_CC,$($(TMD)CC) -xpch=use:$(dir $1)$(basename $(notdir \
  $(PCH)))_c $(DEF_CFLAGS) $(CC_PARAMS) $(COPTS) -o $1 $(PCH_GEN_DIR)$(notdir $2).c $(CFLAGS),$1,$2,$(UDEPS_INCLUDE_FILTER))
...
PCH_CXX = $(call SUP,$(TMD)PCHCXX,$2)$(call WRAP_CC,$($(TMD)CXX) -xpch=collect:$(dir $1)$(basename $(notdir \
  $2))_cc $(DEF_CXXFLAGS) $(CC_PARAMS) $(CXXOPTS) -o $1 $3 $(CXXFLAGS),$1,$3,$(UDEPS_INCLUDE_FILTER))
PCH_CC  = $(call SUP,$(TMD)PCHCC,$2)$(call WRAP_CC,$($(TMD)CC) -xpch=collect:$(dir $1)$(basename $(notdir \
  $2))_c $(DEF_CFLAGS) $(CC_PARAMS) $(COPTS) -o $1 $3 $(CFLAGS),$1,$3,$(UDEPS_INCLUDE_FILTER))
