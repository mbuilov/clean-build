...
# note: used as $(SED) expression to match included system headers
...
OBJ_PCC  = $(call SUP,$(TMD)PCC,$2)$(call WRAP_SUNCC,$($(TMD)CC) -xpch=use:$(dir $1)$(basename $(notdir \
  $(PCH)))_c $(call CC_PARAMS,$1,$(PCH_GEN_DIR)$(notdir $2).c,$3,$4),$1,$(UDEPS_INCLUDE_FILTER))
OBJ_PCXX = $(call SUP,$(TMD)PCXX,$2)$(call WRAP_SUNCC,$($(TMD)CXX) -xpch=use:$(dir $1)$(basename $(notdir \
  $(PCH)))_cc $(call CXX_PARAMS,$1,$(PCH_GEN_DIR)$(notdir $2).cc,$3,$4),$1,$(UDEPS_INCLUDE_FILTER))
...
$(call CLEAN_BUILD_PROTECT_VARS,CC CXX AR TCC TCXX TAR CFLAGS CXXFLAGS CPU_CFLAGS CPU_CXXFLAGS \
  ...
  UDEPS_INCLUDE_FILTER CMN_CFLAGS DEF_CFLAGS DEF_CXXFLAGS CMN_PARAMS CC_PARAMS CXX_PARAMS \
