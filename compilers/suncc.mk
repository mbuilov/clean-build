...
# archiver flags for the tool mode
TARFLAGS     := $(ARFLAGS)
...
# $2 - source
# target-specific: TMD
CMN_CC  = $(call SUP,$(TMD)CC,$2)$(call WRAP_CC,$($(TMD)CC) $(CC_PARAMS),$1,$(UDEPS_INCLUDE_FILTER))
CMN_CXX = $(call SUP,$(TMD)CXX,$2)$(call WRAP_CC,$($(TMD)CXX) $(CXX_PARAMS),$1,$(UDEPS_INCLUDE_FILTER))
...
PCH_CC  = $(call SUP,$(TMD)PCHCC,$2)$(call WRAP_CC,$($(TMD)CC) -xpch=collect:$(dir $1)$(basename $(notdir \
  $2))_c $(call CC_PARAMS,$1,$3),$1,$(UDEPS_INCLUDE_FILTER))
PCH_CXX = $(call SUP,$(TMD)PCHCXX,$2)$(call WRAP_CC,$($(TMD)CXX) -xpch=collect:$(dir $1)$(basename $(notdir \
  $2))_cc $(call CXX_PARAMS,$1,$3),$1,$(UDEPS_INCLUDE_FILTER))
...
$(call CLEAN_BUILD_PROTECT_VARS,CC CXX AR TCC TCXX TAR PIC_COPTION PIE_LOPTION DLL_EXPORTS_DEFINE DLL_IMPORTS_DEFINE \
  LDFLAGS TLDFLAGS CMN_LDFLAGS EXE_LDFLAGS DLL_LDFLAGS ARFLAGS CXX_ARFLAGS TARFLAGS TCXX_ARFLAGS CFLAGS CXXFLAGS \
  CPU64_COPTIONS CPU64_CXXOPTIONS CPU_CFLAGS CPU_CXXFLAGS TCPU_CFLAGS TCPU_CXXFLAGS GET_LINKER MK_RPATH_OPTION \
