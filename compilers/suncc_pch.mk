...
$9 $(10): $2 | $8 $4 $$(ORDER_DEPS)
	$$(if $$($7_PCH_BUILT),,$$(eval $7_PCH_BUILT:=1)$$(call PCH_$1_$7,$8,$$(PCH),$v))
$(subst $(space),$(newline),$(join $(addsuffix :|,$(11)),$(addprefix $4/,$(addsuffix $(suffix $8),$(notdir $3)))))
...
# $10 - compiled pch extension: .cpch or .Cpch (extension is predefined by compiler)
# $v  - R,P,D
...
# note: new value of NEEDED_DIRS will be accounted in next expanded C_BASE_TEMPLATE
# note: last line must be empty
...
#   or $(filter $(CXX_MASK),$(call fixpath,$(WITH_PCH)))
# $4 - pch source suffix: c or cc
# note: pch souce: $4/$(basename $(notdir $2))_pch.$5
...
# generate sources for compiling with precompiled header as assumed by PCH_TEMPLATE macro or
# $1 - EXE,LIB,DLL,KLIB
# $2 - $(basename $(notdir $(PCH)))
# $3 - $(filter $(CC_MASK),$(WITH_PCH))
# $4 - $(filter $(CXX_MASK),$(WITH_PCH))
PCH_TEMPLATEt = $(call PCH_TEMPLATEt1,$(call FORM_OBJ_DIR,$1),$2,$3,$4)
...
$(call SET_GLOBAL,SUNCC_PCH_RULE_TEMPL=v SUNCC_PCH_SRC_GEN=s SUNCC_PCH_RULE=v PCH_TEMPLATEv=v SUNCC_PCH_TEMPLATEt=t)
