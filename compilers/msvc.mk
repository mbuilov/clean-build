...
# msvc compiler toolchain (app-level), included by $(CLEAN_BUILD_DIR)/types/_c.mk
...
# note: override definition in $(CLEAN_BUILD_DIR)/types/_c.mk
...
# note: override defaults in $(CLEAN_BUILD_DIR)/types/_c.mk
EXE_SUFFIX := .exe
...
# note: used by EXE_TEMPLATE and DLL_TEMPLATE from $(CLEAN_BUILD_DIR)/types/_c.mk
...
# $4 - non-empty variant: R,S,RU,SU
# target-specific: TMD
# note: used by LIB_TEMPLATE from $(CLEAN_BUILD_DIR)/types/_c.mk
