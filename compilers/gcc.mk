...
$(call SET_GLOBAL,CROSS_PREFIX CC CXX AR TCC TCXX TAR PIC_COPTION PIE_COPTION PIE_LOPTION \
  DLL_EXPORTS_DEFINE DLL_IMPORTS_DEFINE LDFLAGS TLDFLAGS CMN_LDFLAGS EXE_LDFLAGS DLL_LDFLAGS ARFLAGS TARFLAGS \
  CFLAGS CXXFLAGS CPU_CFLAGS CPU_CXXFLAGS TCPU_CFLAGS TCPU_CXXFLAGS GET_LINKER PIPE_OPTION WLPREFIX MK_RPATH_OPTION \
  RPATH_LINK MK_RPATH_LINK_OPTION BEGIN_STATIC_LIBS_OPTION BEGIN_DYNAMIC_LIBS_OPTION CMN_LIBS \
