...
# $1 - EXE,DLL,DRV,KDLL
# $2 - $(WIN_RC_PRODUCT_DEFS_HEADER)
STD_RES_TEMPLATE1 = $(foreach v,$(call GET_VARIANTS,$1),$(call STD_RES_TEMPLATE2,$1,$2,$(call FORM_TRG,$1,$v),$(call FORM_OBJ_DIR,$1,$v)))
...
$(call CLEAN_BUILD_PROTECT_VARS,WIN_RC_VERSION_TEMPLATE WIN_RC_PRODUCT_DEFS_HEADER WIN_RC_INCLUDE \
  ...
  WIN_RC_PATCHED WIN_RC_WRITE_BY_LINES STD_RES_TEMPLATE2 STD_RES_TEMPLATE1 STD_RES_TEMPLATE)

## add resource to the target
## $1 - target file, e.g. $(call FORM_TRG,type,$v), where type - EXE,DLL,DRV,KDLL
## note: postpone expansion of RES, it may be modified while evaluation of build template
## note: last line must be empty
