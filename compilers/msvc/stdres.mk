...
# note: VCINCLUDE and UMINCLUDE - defined in $(CLEAN_BUILD_DIR)/compilers/msvc.mk
RC_WINVER_INCLUDE = $(VCINCLUDE) $(UMINCLUDE)
...
$4/$5.res: $4/$5.rc $2 | $4
	$$(call RC_COMPILER,$$@,$$<,$$(call qpath,$$(RC_WINVER_INCLUDE),/I))
$3: $4/$5.res
...
$(call SET_GLOBAL,C_PREPARE_MSVC_STDRES_VARS \
  ...
  WIN_RC_PATCHED WIN_RC_WRITE_BY_LINES WIN_RC_STDRES_NAME RC_WINVER_INCLUDE STD_RES_TEMPLATE2 STD_RES_TEMPLATE1 STD_RES_TEMPLATE)
