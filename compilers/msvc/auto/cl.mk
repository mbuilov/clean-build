...
# find msvc C/C++ compiler, included by $(CLEAN_BUILD_DIR)/compilers/msvc/auto/conf.mk

# processor architecture of non-prefixed Visual Studio tools (used for pre-Visual Studio 2017)
...
VCCL_2005_PATTERN_GEN_VS = VC/bin/$(call VC_TOOL_PREFIX_2005,$(TOOLCHAIN_CPU),$(CPU),$(call VS_CPU,$(firstword $2)))cl.exe
