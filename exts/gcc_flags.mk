...
GCC4_PEDANTIC_CXXFLAGS := -fstrict-overflow -Wabi -Waddress -Waggressive-loop-optimizations -Waliasing -Walign-commons -Wall -Wampersand \
 -Warray-bounds -Wattributes -Wbuiltin-macro-redefined -Wcast-align -Wcast-qual -Wchar-subscripts -Wcharacter-truncation \
 -Wclobbered -Wcomment -Wcompare-reals -Wconversion -Wconversion-extra -Wcoverage-mismatch -Wcpp -Wdeprecated -Wdeprecated-declarations \
 -Wdisabled-optimization -Wdiv-by-zero \
 -Wdouble-promotion -Wempty-body -Wendif-labels -Wenum-compare \
 ...
 -Wvector-operation-performance -Wvla -Wvolatile-register-var -Wwrite-strings# -Waggregate-return

GCC4_PEDANTIC_CFLAGS := $(GCC4_PEDANTIC_CXXFLAGS) -Wbad-function-cast -Wc++-compat -Wc++11-compat -Wdeclaration-after-statement \
...
GCC4_PEDANTIC_CXXFLAGS += -Wabi-tag -Wconversion-null -Wctor-dtor-privacy -Wdelete-non-virtual-dtor -Weffc++ -Wno-old-style-cast \
 -Wno-long-long -Wno-variadic-macros# -fvisibility-inlines-hidden
...
GCC5_PEDANTIC_CXXFLAGS := $(filter-out -Warray-bounds,$(GCC4_PEDANTIC_CXXFLAGS)) $(GCC5_PEDANTIC_CFLAGS) -pedantic-errors -Wc++11-compat -Wc++14-compat \
 -Wconditionally-supported -Wdelete-incomplete -Wliteral-suffix \
...
GCC5_PEDANTIC_CFLAGS := $(filter-out -Warray-bounds,$(GCC4_PEDANTIC_CFLAGS)) $(GCC5_PEDANTIC_CFLAGS) -Wincompatible-pointer-types -Wnested-externs
