...
#  may be set in target makefile before expanding INSTALL_LIBS_TEMPLATE to specify per-library installation configuration
define DEFINE_INSTALL_LIB_VARIABLES
...
install_$1: $$($1_BUILT_LIBS) $$($1_BUILT_DLLS)
install: install_$1
...
DST_INC_DIR := $(subst $(space),\ ,$(DESTDIR)$(INCLUDEDIR))$($1_LIBRARY_HDIR)
DST_LIB_DIR := $(subst $(space),\ ,$(DESTDIR)$(LIBDIR))
$(call CLEAN_BUILD_PROTECT_VARS1,DST_INC_DIR DST_LIB_DIR)
endef
...
ifndef $1_LIBRARY_NO_INSTALL_HEADERS
ifdef $1_LIBRARY_HEADERS
...
$(call SET_GLOBAL,INSTALL_LIBS_TEMPLATE DESTDIR \
  ...
  DEFINE_INSTALL_VARIABLES_WIN INSTALL_MKDIR ADD_INSTALL_DIRS ADD_INSTALL_DIR INSTALL_LIBS_TEMPLATE_WINDOWS)
