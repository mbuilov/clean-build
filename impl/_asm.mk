...
# $t - EXE,DLL,LIB...
# $v - non-empty variant: R,P,S,...
define ASM_TEMPLATE_BODY
$1:$(call OBJ_RULES,ASM,$(filter %.asm,$2),$3,$4)
$1:ASMFLAGS := $(TRG_ASMFLAGS)
endef

# to add more target-specific variables, just override ASM_TEMPLATE
ASM_TEMPLATE = $(ASM_TEMPLATE_BODY)

# patch C_BASE_TEMPLATE_BODY
$(call define_append,C_BASE_TEMPLATE_BODY,$(newline)$$(ASM_TEMPLATE))

# tools colors
ASM_COLOR := [37m

# reset ASMFLAGS at beginning of target makefile
$(call define_append,PREPARE_C_VARS_BODY,$(newline)ASMFLAGS:=)

# add assembler-specific definitions
include $(ASM_COMPILER)

# optimization
$(call try_inline,ASM_TEMPLATE,ASM_TEMPLATE_BODY)

# protect variables from modifications in target makefiles
$(call SET_GLOBAL,TRG_ASMFLAGS ASM_TEMPLATE_BODY ASM_TEMPLATE ASM_COLOR)
