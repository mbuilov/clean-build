...
sh_print_env = $(foreach =,$(call uniq,$(project_exported_vars) $(cb_changed_env_vars)),export $=='$($=)'$(newline)|)
...
ifdef verbose
sh_copy_files2 = $(CP) -pv $1 $2 >&2
else
sh_copy_files2 = $(CP) -p $1 $2
endif
...
# note: if path to directory/file $2 contains a space, use 'ifaddq' to add quotes: '1 2/3 4'
sh_simlink_files2 = $(LN) -sfv $1 $2 >&2
endif
...
#  created by this command
ifdef verbose
sh_copy_dir = $(CP) -rpv $1 $2 >&2
else
sh_copy_dir = $(CP) -rp $1 $2
endif
...
# note: if path to directory/file $2 contains a space, use 'ifaddq' to add quotes: '1 2/3 4'
sh_install_files2 = $(INSTALL) -v $3 $1 $2 >&2
endif

# protect macros from modifications in target makefiles, allow tracing calls to them
# note: trace namespace: utils
$(call set_global,sh_print_env=project_exported_vars sh_rm_some_files sh_rm_some_dirs sh_try_rm_some_empty_dirs \
  sh_rm_files_in1_info sh_copy_files2 sh_move2 sh_simlink_files2 sh_mkdir sh_copy_dir sh_simlink_dir sh_chmod_some_files \
  sh_execute_in_info sh_install_dir sh_install_files2,utils)
