" contents of ~/.vim/after/syntax/make.vim
syn match makeTrailSpaces   / *$/ containedin=makeDefine,makeIdent,makeCallFn
...
syn match makeVarDelayedRef /\$\$[^$({,]/ containedin=makeIdent,makeDefine,makeMacroRef,makeCallFn
...
syn match makeVarRef        /$[^$({,]/ containedin=makeIdent,makeDefine,makeMacroRef,makeCallFn
...
syn region makeCallFn       matchgroup=makeStatement start="\$(call\>"hs=s+2 end="[,)]"me=e-1 contained containedin=makeBraces contains=makeIdent
