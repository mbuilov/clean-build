...
$(call CLEAN_BUILD_PROTECT_VARS,BLD_TARGETS NO_DEPS ADD_OBJ_SDEPS=x OBJ_RULES2=t;v OBJ_RULES1=t;v OBJ_RULES=t;v \
  ...
  TRG_INCLUDE=t;v TRG_DEFINES=t;v TRG_CFLAGS=t;v TRG_CXXFLAGS=t;v TRG_ASMFLAGS=t;v TRG_LDFLAGS=t;v \
  GET_SOURCES TRG_SRC TRG_SDEPS GET_OBJS VARIANT_LIB_MAP VARIANT_IMP_MAP \
  DEP_LIB_SUFFIX DEP_IMP_SUFFIX MAKE_DEP_LIBS MAKE_DEP_IMPS DEP_LIBS DEP_IMPS \
  ...
  EXE_TEMPLATE=t;v LIB_TEMPLATE=t;v DLL_TEMPLATE=t;v KLIB_TEMPLATE=t;v DRV_TEMPLATE=t;v \
