...
# note: 'gen_dir' - defined in $(cb_dir)/core/_defs.mk
...
$(generated): $(if $(product_build),,| $(call get_tool,buildnumber))
	$(if $(build),,$(eval $@: build := $(shell $(firstword $|))))
	$(if $(build),,$(error 'product_build' is not defined and failed to determine it))
	$(call suppress,GEN,$@)$(call print_text,$(subst <build_date_time>,$(subst /,-,$(word \
