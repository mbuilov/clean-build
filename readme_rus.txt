...
Однако, если нужно задать поядок выполнения целей Makefile'ов как в рекурсивной системе сборки, этот порядок нужно указывать явно, например my_dll.mk:my_lib.mk.
...
* и функции
 ...
 normp    - нормализация пути - удаление избыточных относительных смен директорий в пути (a/b/../c -> a/c),
 reldir   - вычисление относительного пути от одной директории к другой ($(call reldir,/aa/bb/cc,/aa/dd/qq) -> ../../dd/qq),
 и др.
