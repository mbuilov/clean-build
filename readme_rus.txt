...
функции:
 ...
 qpath    - добавление префикса, если необходимо, то обрамление аргумента двойными кавычками и замена ? на пробелы в аргументе (эта функция, например, используется для формирования списка путей поиска #include файлов языка C при сборке с использованием MS Visual Studio),
