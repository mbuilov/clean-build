...
2) make_header.mk      - общие шаблоны для сборки целей на языках C или C++, включает в себя следующие файлы:
  ...
  b) include $(MTOP)/$(OS)/make_header.mk - утилиты и дополнительные шаблоны для сборки целей на языках C или C++ (компиляторы)

3) make_jheader.mk     - общие шаблоны для сборки целей на языках JAVA и SCALA, включает в себя следующие файлы:
  a) make_defs.mk      - описан выше
