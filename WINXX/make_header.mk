...
# remember all MC-generated by current makefile .rc files in format: makefile-timestamp|generated_rc
# check this list to avoid recursive dependencies then adding MC-generated .rc to resources list
MC_GENERATED_RC :=
...
MC_GENERATED_RC += $$(addsuffix |$$(MC_RC),$(SUB_LEVEL))
endef
...
NEEDED_DIRS += $5
$2: $(patsubst %|$2,%,$(filter-out $(MC_GENERATED_RC),$(addsuffix |$2,$(CURRENT_DEPS))))
