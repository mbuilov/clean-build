...
KLIB_PARAMS ?= -pipe -c $(KERN_FLAGS) $(AUTO_DEPS_FLAGS) $(call \
...
$(call CLEAN_BUILD_APPEND_PROTECTED_VARS,CC CXX MODULES_PATH LD AR TCC TCXX TLD TAR KCC KLD KMAKE YASMC FLEXC BISONC \
