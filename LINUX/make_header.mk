...
# default flags for static library linker
...
CMN_LIBS  = -pipe -o $1 $2 $(DEF_SHARED_FLAGS) $(addprefix $(WLPREFIX)-rpath=,$(strip \
...
EXE_P_LD  = $(call SUPRESS,$(TMD)LD,$1)$($(TMD)$(COMPILER)) $(DEF_EXE_FLAGS) $(call CMN_LIBS,$1,$2,P) -pie
DLL_R_LD  = $(call SUPRESS,$(TMD)LD,$1)$($(TMD)$(COMPILER)) $(DEF_SO_FLAGS) $(addprefix \
             $(WLPREFIX)--version-script=,$(MAP)) $(call CMN_LIBS,$1,$2,D)
LIB_R_LD  = $(call SUPRESS,$(TMD)AR,$1)$($(TMD)AR) $(DEF_AR_FLAGS) $1 $2
LIB_P_LD  = $(call SUPRESS,$(TMD)LD,$1)$($(TMD)LD) $(DEF_LD_FLAGS) -o $1 $2 $(LDFLAGS)
LIB_D_LD  = $(call SUPRESS,$(TMD)LD,$1)$($(TMD)LD) $(DEF_LD_FLAGS) -o $1 $2 $(LDFLAGS)
