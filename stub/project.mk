...
# BUILD - path to the directory where artifacts (object files, libraries, executables, etc.) are built
# Note: this variable is required by the clean-build and must be defined prior including core clean-build files
# Note: $(BUILD) directory is automatically created by the clean-build when building targets and automatically
...
# include core clean-build definitions, processing of the CONFIG and OVERRIDES variables,
