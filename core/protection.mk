...
cb_var_access_err = $(eval $(findstring override,$(origin $=)) $$==!$$(error \
  using local variable $=, please define instead target-specific variable or register a global one via 'set_global' macro))
...
cb_protected_var_ov = $(error $= value was changed:$(newline)--- old value:$(newline)$(value \
