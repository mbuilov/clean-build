...
# utilities colors
GEN_COLOR     := [1;32m
MGEN_COLOR    := $(GEN_COLOR)
CP_COLOR      := [1;36m
RM_COLOR      := [1;31m
DEL_COLOR     := $(RM_COLOR)
DEL_DIR_COLOR := $(RM_COLOR)
LN_COLOR      := [36m
MKDIR_COLOR   := [36m
TOUCH_COLOR   := [36m
CAT_COLOR     := [32m
...
$(call SET_GLOBAL,PROJECT_VARS_NAMES PASS_ENV_VARS \
  ...
  GEN_COLOR MGEN_COLOR CP_COLOR RM_COLOR DEL_COLOR DEL_DIR_COLOR LN_COLOR MKDIR_COLOR TOUCH_COLOR CAT_COLOR SED_COLOR \
