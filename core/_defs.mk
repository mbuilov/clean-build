...
# reset $(group_name)_NON_PARALEL_GROUP variable before rule execution second phase
ifdef MCHECK
...
$(call SET_GLOBAL,PROJECT_VARS_NAMES PASS_ENV_VARS \
  ...
  NEED_GEN_DIRS STD_TARGET_VARS1 STD_TARGET_VARS MAKEFILE_INFO_TEMPL SET_MAKEFILE_INFO GET_TARGET_NAME \
