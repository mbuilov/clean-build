...
# note: 'shell_escape', 'sh_execute_in_info' macros - are defined in $(utils_mk) makefile
...
show_tool_vars = $(info $(if $3,$(call sh_execute_in_info,$3,$(show_tool_vars1)),$(show_tool_vars1)))
...
# note: 'sh_execute_in' macro - defined in $(utils_mk) makefile
...
run_tool = $(if $2$4,$(if $2,$(eval $$@:export $$(dll_path_var):=$(if $(findstring undefined,$(origin $(dll_path_var))),,$(if \
  ...
  $(verbose),$(show_tool_vars)@))$(if $3,$(call sh_execute_in,$3,$1),$1)$(if $2$4,$(if $(verbose),$(show_tool_vars_end)))
